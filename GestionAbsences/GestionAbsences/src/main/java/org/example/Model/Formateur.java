...
public class Formateur extends User {
    ...
    public Formateur(int id_user, String nom, String prenom, String email, String password,String tele, String role, String dateNaissance, int id_formateur, int id_sp, int id_salle, int id_user1) {
