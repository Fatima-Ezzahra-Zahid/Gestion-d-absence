...
public class SpecialiteDaoImp implements SpecialiteDao{
    ...
    public void updateSpecialite(String nomSpecialite, int nbrCompetence, int id) throws ClassNotFoundException, SQLException {
        ...
        try{
            String requete = "Update specialite set nom_sp=?,numbreDeModule=? where id_specialite=?";
            PreparedStatement statement = ConnectionClass.getMyConnexion().prepareStatement(requete);
    ...
    public ObservableList<Specialite> AfficheSpecialite()
    {
        ...
        try {
            ...
            String requete="SELECT id_specialite, nom_sp,numbreDeModule FROM specialite";
            PreparedStatement statement = ConnectionClass.getMyConnexion().prepareStatement(requete);
